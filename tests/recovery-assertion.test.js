...
(async () => {
  Recovery.setContext({ rpId: 'koinvault.app', origin: 'https://koinvault.app' });
  ...
  assert.strictEqual(cd.origin, 'https://koinvault.app');
  ...
  assert.deepStrictEqual(
    ...
    crypto.createHash('sha256').update('koinvault.app').digest());
