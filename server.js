...
const CFG = {
  ...
  /* WebAuthn relying-party ID for koinvault.app. Override only for
     a deliberately different deployment; existing passkeys are domain-bound. */
  passkeyRpId: (process.env.PASSKEY_RPID || 'koinvault.app').trim(),
