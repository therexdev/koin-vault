...
STEP 1 — Add four secrets to GitHub.
  ...
  Open: https://github.com/therexdev/koin-vault/settings/secrets/actions
...
STEP 3 — Build a signed app.
  ...
  https://github.com/therexdev/koin-vault/actions/workflows/android.yml
  → "Run workflow" → Run. When it finishes, the .aab for Play is on:
  https://github.com/therexdev/koin-vault/releases/tag/android-latest
