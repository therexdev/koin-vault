...
| Website | https://koinvault.app/android/ |
| Privacy policy | https://koinvault.app/android/privacy |
| Account/data deletion URL | https://koinvault.app/android/delete-account |
...
2. Download the matching `bio-wallet-<version>.aab` from the
   [Android release](https://github.com/therexdev/koin-vault/releases/tag/android-latest).
